...
public class FilterDesignController extends BaseController {
    ...
    public void getSolutionList(@RequestBody HashMap<String, Integer> paramMap, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            if (null == paramMap || null == paramMap.get("filterId")) {
                ...
                if (null == terminalType || "2".equals(terminalType)) terminalType = "1";
                List<FilterSolution> solutionList = UIMetaEngine.getInstance().getSolutionList(filterId, terminalType, CommonUtil.getUserId(), CommonUtil.getTenantId(), null);
    ...
    public void getSolutionCommonList(@RequestBody HashMap<String, Integer> paramMap, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            List<FilterSolutionCommon> solutionCommonList = UIMetaEngine.getInstance().getSolutionCommonList(solutionId, CommonUtil.getTenantId(), null);
    ...
    public void saveSolution(@RequestBody Map<String, Object> solution, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            UIMetaEngine.getInstance().saveSolution(solution, CommonUtil.getTenantId(), null);
    ...
    public void setDefaultFilter(@RequestParam int solutionId, Integer terminalType, HttpServletRequest request, HttpServletResponse response) {
        try {
            UIMetaEngine.getInstance().setDefaultFilter(terminalType,solutionId, CommonUtil.getTenantId(), null);
            this.renderJson(response, ResultMessage.success());
        } catch (Exception e) {
